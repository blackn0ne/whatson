...
function FeaturesSection({ landing }) {
    ...
    return (
        <section id="features" className="py-24 bg-neutral-50 dark:bg-neutral-900/30">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
...
function PricingSection({ plans }) {
    ...
    return (
        <section id="pricing" className="py-24 bg-neutral-50 dark:bg-neutral-900/30">
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        return (
                            <div
                                ...
                                className={`relative rounded-2xl border p-7 flex flex-col ${
                                    plan.is_featured
                                        ? 'border-[#5a8b38]/50 bg-[#162610] text-white shadow-2xl shadow-[#5a8b38]/10 scale-105'
