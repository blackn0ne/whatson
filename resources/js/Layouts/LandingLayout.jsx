            ...
            <header className="sticky top-0 z-50 border-b border-white/10" style={{ background: '#162610' }}>
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between gap-6">
                    ...
                    <Link href={route('home')} className="flex items-center group flex-shrink-0">
                        <img src="/whatsmine-logo.png" alt={appName} className="h-9 w-auto max-w-[180px] object-contain transition-opacity group-hover:opacity-80" />
                    </Link>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-12">
                        ...
                        <div className="col-span-2 sm:col-span-1">
                            <Link href={route('home')} className="flex items-center mb-4">
                                <img src="/whatsmine-logo.png" alt={appName} className="h-9 w-auto max-w-[180px] object-contain" />
                            </Link>
